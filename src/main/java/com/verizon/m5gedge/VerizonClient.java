    ...
    private VerizonClient(Environment environment, String vZM2mToken, HttpClient httpClient,
        ...
        if (this.authentications.containsKey("oAuth2")) {
            this.clientCredentialsAuthManager =
                    (ClientCredentialsAuthManager) this.authentications.get("oAuth2");
        }

        if (!this.authentications.containsKey("oAuth2")
                || !getClientCredentialsAuth().equals(clientCredentialsAuthModel.getOauthClientId(),
                        clientCredentialsAuthModel.getOauthClientSecret(),
                        clientCredentialsAuthModel.getOauthToken(),
                        clientCredentialsAuthModel.getOauthScopes())) {
    ...
    public static class Builder {
        ...
        public VerizonClient build() {
            ...
            return new VerizonClient(environment, vZM2mToken, httpClient, httpClientConfig,
                    clientCredentialsAuthModel, authentications);
        }
    }
}